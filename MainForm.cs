...
namespace DreamBeam {
	...
	public class MainForm : System.Windows.Forms.Form {
		...
		public MainForm(string[] args) {
			...
			SermonToolDocuments sermon = (SermonToolDocuments)SermonToolDocuments.DeserializeFrom(typeof(SermonToolDocuments), Path.Combine(Tools.DreamBeamPath(), ConfigSet + ".SermonDocs.xml"));
			if (sermon != null) {
		...
		private void InitializeComponent() {
			...
			this.Fade_panel.Size = new System.Drawing.Size(-188, 685);
			...
			this.Presentation_Fade_ListView.Size = new System.Drawing.Size(-188, 533);
			...
			this.BibleText_Verse_ComboBox.Size = new System.Drawing.Size(264, 20);
			...
			this.BibleText_RegEx_ComboBox.Size = new System.Drawing.Size(328, 20);
		...
		private void MainForm_Closing(object sender, System.ComponentModel.CancelEventArgs e) {
			...
			SermonToolDocuments.SerializeTo(sermons, Path.Combine(Tools.DreamBeamPath(), ConfigSet + ".SermonDocs.xml"));
			...
			Config.SerializeTo(this.Config, Path.Combine(Tools.DreamBeamPath(), ConfigSet + ".config.xml"));
		}
