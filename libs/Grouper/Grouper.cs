...
namespace CodeVendor.Controls
{
	...
	public class Grouper : System.Windows.Forms.UserControl
	{
        ...
        private bool V_TitleBorder = true;
        private bool V_TinyMode = false;
		#endregion
        ...
        /// <summary>This feature will change the control's shadow color.</summary>
        [Category("Appearance"), Description("Use Title Border")]
        public bool TitleBorder { get { return V_TitleBorder; } set { V_TitleBorder = value; this.Refresh(); } }

        /// <summary>This feature makes the Grouper smaller.</summary>
        [Category("Appearance"), Description("Small Title")]
        public bool TinyMode { get { return V_TinyMode; } set { V_TinyMode = value; this.Refresh(); } }
		...
		private void PaintGroupText(System.Drawing.Graphics g)
		{
			...
			//Paint Borded-----------------------
            if (this.V_TitleBorder) { g.DrawPath(BorderPen, path); }
			//-----------------------------------
            
			//Paint Text-------------------------
			int CustomStringWidth = (this.GroupImage!=null) ? 44 : 28;
            if (V_TinyMode) { g.DrawString(this.GroupTitle, this.Font, TextColorBrush, CustomStringWidth, 0); }
            else { g.DrawString(this.GroupTitle, this.Font, TextColorBrush, CustomStringWidth, 5); }
			//-----------------------------------
